...
export default function HeroCover() {
  ...
  return (
    <motion.section
      ...
      className="relative w-full min-h-screen bg-brand-black overflow-hidden flex flex-col justify-end md:justify-center px-6 md:px-24 py-16 md:py-0 select-none"
    >
