...
export const brotherData: BrotherData = {
  ...
  timeline: [
    ...
    },
    {
      year: "18",
      title: "DEBUT SEASON",
      description: "Entering adulthood. License to race obtained. Navigating adult track days.",
  ...
  twentyOneThings: [
    ...
    { number: "05", title: "THE LATE NIGHTS", description: "Burning fuel at 3 AM. Midnight conversations and adjustments." },
    ...
    { number: "19", title: "THE HUSTLE", description: "Always building, creating, upgrading. Continuous engine updates." },
